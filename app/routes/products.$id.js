...
function ParentSummarySection({ product, onUpdated, }) {
    ...
    const [officialPrice, setOfficialPrice] = useState(product.officialPrice != null && product.officialPrice > 0
    ...
    useEffect(() => {
        ...
        setOfficialPrice(product.officialPrice != null && product.officialPrice > 0
            ? String(product.officialPrice)
            : "");
    }, [product]);
    ...
    const priceLabel = product.price != null
        ...
        : t("common.emptyValue");
    const officialPriceLabel = product.officialPrice != null && product.officialPrice > 0
