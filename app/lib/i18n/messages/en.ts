...
export const en = {
  ...
  orderDetail: {
    ...
    confirmCancelShipped:
      "Refund this order? Stock already shipped will not be restocked automatically.",
    ...
    deliverOrderHint: "Record that the carrier handed this shipment to the customer.",
    deliveredAt: "Delivered",
    deliveredBy: "by {name}",
    autoFulfillDue: "Auto-completes {time} unless the customer responds",
    ...
    confirmApproveCancel: "Approve this cancellation and refund the captured payment?",
    rejectCancel: "Reject cancel",
    disputeReported: "Customer reports this order was never received",
    disputeReason: "Reason: {reason}",
    resolveDispute: "Resolve — delivered",
    resolveDisputeHint: "Close the dispute without a refund (proof of delivery, found package, etc.). To side with the customer instead, cancel the order.",
    orderId: "Order ID",
    customer: "Customer",
    timeline: "Timeline",
    meta: "Details",
  ...
  orders: {
    ...
    shippedAt: "Shipped",
    shippedBy: "by {name}",
    receiptConfirmedAt: "Receipt confirmed",
