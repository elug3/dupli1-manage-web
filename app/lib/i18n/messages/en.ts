...
export const en = {
  ...
  promotions: {
    ...
    scope: "Audience",
    scopeGlobal: "Global — anyone, once each",
    scopeSingleUser: "Single user — needs an issued entitlement",
    scopeSingleUserShort: "single user",

    benefitType: "Benefit",
    benefitPercent: "Percent off",
    benefitFixed: "Fixed ₩ off",
    ...
    termsPlaceholder: "10% off orders over 100,000원, until Aug 31",

    conditionsTitle: "Conditions",
    conditionsHint:
      "All conditions must hold. Line conditions are read per cart item; no conditions means the code always applies.",
    noConditions: "No conditions — applies to any cart.",
    addCondition: "Add condition",
    removeCondition: "Remove",
    conditionAttr: "Attribute",
    conditionOp: "Comparison",
    ...
    attrSkuId: "Item SKU id",
    attrProductId: "Item product id",
    attrOnSale: "Item is on sale",
    ...
    percentWithCap: "{percent} (max {cap})",

    liveEditWarning:
      "This code has been used {count} time(s). Edits never change past orders, but they change what the next customer gets.",
    deleteWarning:
      "Deleting removes the definition outright. Pause it instead if you may want it back.",
    deleteLiveWarning:
      "This code has been used {count} time(s). Deleting removes the definition that explains those orders — pause it instead.",
    ...
    promotionUpdated: "Promotional code updated: {code}",
    ...
    errRedemptionCap: "Campaign cap must be a whole number above 0",
    errConditionValue: "Every condition needs a value",
