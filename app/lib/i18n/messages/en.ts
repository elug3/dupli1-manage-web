...
export const en = {
  ...
  orderDetail: {
    ...
    confirmAccept: "Accept this paid order for fulfillment?",
    confirmDeliver: "Mark this shipment as delivered to the customer?",
    confirmResolveDispute: "Close this dispute in the delivery's favor (no refund)?",
    orderId: "Order ID",
    customer: "Customer",
    timeline: "Timeline",
    meta: "Details",
